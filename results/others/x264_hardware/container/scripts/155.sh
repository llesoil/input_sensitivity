...
{ time x264  --cabac --ref 3 --deblock 1:0:0 --analyse 0x3:0x113 --me hex --subme 8 --mixed-ref --merange 16 --trellis 2 --8x8dct --no-fast-pskip --chroma-qp-offset 0 --bframes 3 --b-pyramid 2 --b-adapt 1 --direct spatial --weightb --weightp 2 --scenecut 40 --rc-lookahead 10 --no-mbtree --qpmax 69 --aq-mode 0 --output $outputlocation $inputlocation ; } 2> $logfilename
...
csvLine="$numb,1,3,1:0:0,0x3:0x113,hex,8,1,16,2,1,0,0,3,2,1,spatial,1,0,2,40,10,0,69,0,"
