...
![png](bitrate_files/bitrate_19_0.png)
...
![png](bitrate_files/bitrate_23_0.png)
...
![png](bitrate_files/bitrate_32_0.png)
...
![png](bitrate_files/bitrate_35_0.png)
...
res_coef_short = compute_poly(listVideo)
res_coef_short.to_csv("../../results/list_features_importances_poly_"+predDimension+".csv")
res_coef_short
```
...
```python
listImp = [(np.abs(np.percentile(res_coef_short[col],75)-np.percentile(res_coef_short[col],25)),
            res_coef_short[col], col) 
           for col in res_coef_short.columns]
listImp.sort(key=lambda tup: tup[2], reverse=True)
...
plt.boxplot([l[1] for l in listImp], flierprops=red_square, 
          ...
          boxprops=dict(facecolor=(0,0,1,0.5),linewidth=1,edgecolor='k'),
          whiskerprops = dict(linestyle='-.',linewidth=1.0, color='black'))
plt.vlines(x = 0, ymin = 0.5, ymax = 3.5, color="orange", linewidth= 3)
plt.text(s = "Negative impact", x = -0.96, y = 0.6, size = 20, color = 'orange')
plt.text(s = "Positive impact", x = 0.55, y = 0.6, size = 20, color = 'orange')
plt.xlabel("Features coefficients", size = 20)
plt.yticks(range(1, len(listImp) + 1), [l[2] for l in listImp], size= 20)
plt.xlim(-1.1, 1.1)
plt.savefig("../../results/boxplot_features_imp_linear_"+predDimension+"_short.png")
plt.show()
```


![png](bitrate_files/bitrate_37_0.png)
...
![png](bitrate_files/bitrate_49_1.png)



![png](bitrate_files/bitrate_49_2.png)
...
```python
np.where(df.loc[np.argmin(stds),:] == np.max(df.loc[np.argmin(stds),:]))
```




    (array([ 109,  126,  865, 1104, 1267, 1270, 1274, 1281, 1348, 1351]),)
...
![png](bitrate_files/bitrate_61_0.png)
...
![png](bitrate_files/bitrate_61_2.png)
...
![png](bitrate_files/bitrate_61_4.png)
...
![png](bitrate_files/bitrate_61_6.png)
...
```
    ...
    Imp mbtree: 0.34222602739726027
    Imp std mbtree: 0.2240509136899788
    Imp aq-mode: 0.0448972602739726
    Imp std aq-mode: 0.07325356875237994
    Imp subme: 0.35756849315068495
    Imp std subme: 0.24373361293800164



![png](bitrate_files/bitrate_66_1.png)
...
![png](bitrate_files/bitrate_66_3.png)
...
```
    ...
    Imp std mbtree: 0.09449630831996723
    Imp aq-mode: 0.2754042553191489
    Imp std aq-mode: 0.19452546292599615
    Imp subme: 0.48568085106382974
    Imp std subme: 0.24531929748477724
...
```
    ...
    Imp mbtree: 0.05451923076923077
    Imp std mbtree: 0.06715910797519327
    Imp aq-mode: 0.15302884615384615
    Imp std aq-mode: 0.1833055434099648
    Imp subme: 0.5149519230769231
    Imp std subme: 0.24191344128267211
...
```
    ...
    Imp mbtree: 0.47429223744292237
    Imp std mbtree: 0.1949542189181585
    Imp aq-mode: 0.13438356164383564
    Imp std aq-mode: 0.12724678106507953
    Imp subme: 0.14401826484018268
    Imp std subme: 0.14267925402597714
...
```
    ...
    AVG
    [[0.81747322 0.0414419  0.37538304 0.59842234]
     [0.         0.7923419  0.67379695 0.45023686]
     [0.         0.         0.85416018 0.71700603]
     [0.         0.         0.         0.73380599]]
    STD
    [[0.         0.21617771 0.18792134 0.17676751]
     [0.         0.         0.17425259 0.20491938]
     [0.         0.         0.         0.15529403]
     [0.         0.         0.         0.        ]]
    MEDIAN
    [[0.         0.04817805 0.38420647 0.61590102]
     [0.         0.         0.71022817 0.47675224]
     [0.         0.         0.         0.74202928]
     [0.         0.         0.         0.        ]]
...
```
    ...
    Test accuracy : 0.680952380952381
...
```python
n_estimators_tab = [10, 50, 100]
criterion_tab = ["mae", "mse"]
min_samples_leaf_tab = [1, 5, 10]

for net in n_estimators_tab:
    for ct in criterion_tab:
        for mslt in min_samples_leaf_tab:
            ...
            print("n_estimators :", net, ", criterion : ", ct, 
                  ", mslt : ", mslt, ", accuracy : ", np.mean(np.abs(y_pred-y_test)))
```

    n_estimators : 10 , criterion :  mae , mslt :  1 , accuracy :  0.2836220149475067
    n_estimators : 10 , criterion :  mae , mslt :  5 , accuracy :  0.28316789156797195
    n_estimators : 10 , criterion :  mae , mslt :  10 , accuracy :  0.28301556298605995
    n_estimators : 10 , criterion :  mse , mslt :  1 , accuracy :  0.2838862471897719
    n_estimators : 10 , criterion :  mse , mslt :  5 , accuracy :  0.2825471872019862
    n_estimators : 10 , criterion :  mse , mslt :  10 , accuracy :  0.28238792535979285
    n_estimators : 50 , criterion :  mae , mslt :  1 , accuracy :  0.28282167459898794
    n_estimators : 50 , criterion :  mae , mslt :  5 , accuracy :  0.282949263646116
    n_estimators : 50 , criterion :  mae , mslt :  10 , accuracy :  0.28299632454219814
    n_estimators : 50 , criterion :  mse , mslt :  1 , accuracy :  0.2829699145576055
    n_estimators : 50 , criterion :  mse , mslt :  5 , accuracy :  0.2830736669314359
    n_estimators : 50 , criterion :  mse , mslt :  10 , accuracy :  0.2833805655472585
    n_estimators : 100 , criterion :  mae , mslt :  1 , accuracy :  0.2826404820731136
    n_estimators : 100 , criterion :  mae , mslt :  5 , accuracy :  0.28348771306390874
    n_estimators : 100 , criterion :  mae , mslt :  10 , accuracy :  0.2819927916705308
    n_estimators : 100 , criterion :  mse , mslt :  1 , accuracy :  0.28294202147100367
    n_estimators : 100 , criterion :  mse , mslt :  5 , accuracy :  0.2834723157816824
    n_estimators : 100 , criterion :  mse , mslt :  10 , accuracy :  0.28285160933942827



```python
clf = RandomForestRegressor(n_estimators=100, criterion="mse", min_samples_leaf=5)
...
```
    ...
    [2.52565985e-02 1.22721042e-02 7.98293535e-03 7.79583982e-03
     1.62951643e-01 7.56985358e-02 5.45210123e-02 4.26780665e-02
     1.69915352e-02 1.51527294e-02 1.12917330e-03 1.73388774e-01
     1.69811614e-03 1.51160740e-03 3.51724346e-01 3.91368203e-04
     2.78331555e-03 3.73953784e-03 5.72885847e-04 8.44309815e-04
     4.16681866e-03 2.42170656e-03 2.13176182e-04 3.13990404e-04
     7.33287856e-04 3.74997313e-04 0.00000000e+00 1.13905128e-03
     3.10910141e-03 3.10788282e-03 9.50384472e-03 0.00000000e+00
     1.58317096e-02]
...
```
    ...
    ['SLEEQ_DMOS', 'BANDING_DMOS', 'WIDTH', 'HEIGHT', 'SPATIAL_COMPLEXITY', 'TEMPORAL_COMPLEXITY', 'CHUNK_COMPLEXITY_VARIATION', 'COLOR_COMPLEXITY', 'video_category', 'cabac', 'ref', 'deblock', 'analyse', 'me', 'subme', 'mixed_ref', 'me_range', 'trellis', '8x8dct', 'fast_pskip', 'chroma_qp_offset', 'bframes', 'b_pyramid', 'b_adapt', 'direct', 'weightb', 'open_gop', 'weightp', 'scenecut', 'rc_lookahead', 'mbtree', 'qpmax', 'aq-mode', 'config_size']
...
```python
X_train_m3 = np.array(training_data_m3.drop(["config_size"],axis=1), float)
y_train_m3 = np.array(training_data_m3["config_size"], float)

X_test_m3 = np.array(test_data_m3.drop(["config_size"],axis=1), float)
y_test_m3 = np.array(test_data_m3["config_size"], float)
```


```python
clf_m3 = RandomForestRegressor()

clf_m3.fit(X_train_m3, y_train_m3)
```
    ...
    <ipython-input-347-2430282f3c5d> in <module>
          3 clf_m3.fit(X_train_m3, y_train_m3)
          4 
    ----> 5 y_pred_m3 = clf.predict(X_test_m3)
    

    ~/anaconda3/envs/x264/lib/python3.7/site-packages/sklearn/ensemble/_forest.py in predict(self, X)
    ...
    ~/anaconda3/envs/x264/lib/python3.7/site-packages/sklearn/ensemble/_forest.py in _validate_X_predict(self, X)
    ...
    ~/anaconda3/envs/x264/lib/python3.7/site-packages/sklearn/tree/_classes.py in _validate_X_predict(self, X, check_input)
    ...
    ValueError: Number of features of the model must match the input. Model n_features is 33 and input n_features is 31 



```python
y_pred_m3 = clf_m3.predict(X_test_m3)
```


```python
print(clf_m3.feature_importances_)
```

    [8.48281825e-03 7.27654105e-03 1.04606179e-01 7.01800201e-02
     3.59295318e-02 3.26985731e-02 1.52454875e-02 4.24579612e-02
     2.52852670e-03 7.81883397e-04 3.15197267e-03 2.34697487e-03
     5.05167126e-01 7.78106017e-04 4.31728179e-04 7.19414147e-03
     9.85655361e-04 2.43367280e-03 3.34757665e-03 1.14691798e-02
     7.64456556e-03 7.31962555e-03 1.84423762e-03 9.27673215e-03
     0.00000000e+00 1.52281430e-03 9.81116133e-04 4.39402420e-03
     4.33351131e-02 0.00000000e+00 6.61881148e-02]
...
for ti in test_index:
    ...
    for i in range(nb_config):
        ...
        tab = np.array(video_prop, float)
        rank_prediction = clf.predict(tab.reshape(1, 33))
        config_pred_rank.append(rank_prediction)
        rank_prediction_ce = clf_ce.predict(tab.reshape(1, 33))
        config_pred_rank_ce.append(rank_prediction_ce)
        rank_prediction_m3 = clf_m3.predict(tab[2:].reshape(1, 31))
        config_pred_rank_m3.append(rank_prediction_m3)
    ...
    val_min_m3 = listVideo[index_video].loc[np.argmin(config_pred_rank_m3)][predDimension]
    ...
    val_m3.append(val_min/val_min_m3)
```
...
#plt.arrow(x = 0.05, y = 0.9, dx= 0, dy = 3.1, head_width = .04, head_length = .2, color="orange")
#plt.text(s = "Better", x = 0.09, y = 2.5, size = 20, color = 'orange')
#plt.text(s = "Baseline", x = 0.07, y = 2.2, size = 20, color = 'orange')
#plt.arrow(x = 0.68, y = 4.1, dx= -0.24, dy = 0, head_width = .15, head_length = .05, color="orange")
#plt.text(s = "Inputec is better", x = 0.35, y = 3.7, size = 20, color = 'orange')
plt.yticks([1, 2, 3, 4], 
...
![png](bitrate_files/bitrate_119_0.png)
...
for i in range(len(test_index)):
    ...
    res_rank_mins_mar.append(0)
    res_rank_cost_eff_mar.append(find_rank(sorted_sizes, nb_config-1, cost_eff_mar[i]))
    res_rank_m3_mar.append(find_rank(sorted_sizes, nb_config-1, val_m3_mar[i]))
```
...
```python
pd.Series(res_rank_m3_mar).describe()
```
...
![png](bitrate_files/bitrate_130_0.png)



```python
for i in range(10):
    if res_rank_inputec[i] > res_rank_compromise[i]:
        print("B2 :", np.where([np.array([v[:-4] for v in v_names], str)==test_index[i]]))
    if res_rank_inputec[i] > res_rank_model_reuse[i]:
        print("B1 :", np.where([np.array([v[:-4] for v in v_names], str)==test_index[i]]))
```

    B1 : (array([0]), array([1044]))
    B2 : (array([0]), array([258]))
...
```python
stats.ttest_ind(res_rank_inputec, res_rank_avg, equal_var = False)
```




    Ttest_indResult(statistic=-71.9933147526328, pvalue=5.117053811166775e-260)




```python
stats.ttest_ind(res_rank_inputec, res_rank_compromise, equal_var = False)
```




    Ttest_indResult(statistic=-21.393595878460452, pvalue=7.828896865241657e-73)




```python
stats.ttest_ind(res_rank_inputec, res_rank_model_reuse, equal_var = False)
```




    Ttest_indResult(statistic=-22.83269381630246, pvalue=1.6349024964496132e-81)
...
```
    ...
    MannwhitneyuResult(statistic=218.0, pvalue=7.777612412561599e-32)




```python
mannwhitneyu(res_rank_inputec, res_rank_m3_mar)
```




    MannwhitneyuResult(statistic=59173.0, pvalue=0.2149115558775636)




```python
inputec, res_rank_m3_mar
```
...
![png](bitrate_files/bitrate_151_0.png)
...
![png](bitrate_files/bitrate_152_1.png)
...
```python
for i in range(len(name_col)-1):
    print(name_col[i], ":", clf.feature_importances_[i])
```

    SLEEQ_DMOS : 0.019801704607249584
    BANDING_DMOS : 0.008984382110096861
    WIDTH : 0.006641701441222643
    HEIGHT : 0.00565259290855758
    SPATIAL_COMPLEXITY : 0.0992558888761173
    TEMPORAL_COMPLEXITY : 0.06425498589852231
    CHUNK_COMPLEXITY_VARIATION : 0.029819594441257532
    COLOR_COMPLEXITY : 0.027987033241770997
    video_category : 0.011994086970188963
    cabac : 0.04238123683773863
    ref : 0.002662257100634712
    deblock : 0.0008131883017430562
    analyse : 0.0031743037634444906
    me : 0.002561852742110659
    subme : 0.504663947808957
    mixed_ref : 0.0007356494671616231
    me_range : 0.0003991115596961664
    trellis : 0.0070378009256881705
    8x8dct : 0.0009107855142818945
    fast_pskip : 0.002441839097106163
    chroma_qp_offset : 0.0031041503816468257
    bframes : 0.011109599910556997
    b_pyramid : 0.00812894160433218
    b_adapt : 0.007063342322793984
    direct : 0.0021502026074932887
    weightb : 0.00959097057124924
    open_gop : 0.0
    weightp : 0.0016315521646091467
    scenecut : 0.0010860915064742087
    rc_lookahead : 0.004491890574849891
    mbtree : 0.043445210450804315
    qpmax : 0.0
    aq-mode : 0.06602410429164356
