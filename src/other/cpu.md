...
```
    ...
    Group 1 contains 994 input videos.
    Group 2 contains 212 input videos.
    Group 3 contains 158 input videos.
    Group 4 contains 33 input videos.
...
```
    ...
    ['Animation_1080P-66ba.csv',
     'Animation_1080P-7f27.csv',
     ...
     'LiveMusic_720P-0d9f.csv',
     'LyricVideo_1080P-63d4.csv',
     'LyricVideo_360P-17ce.csv',
     'LyricVideo_360P-7fb1.csv',
     'LyricVideo_480P-0722.csv',
     'LyricVideo_480P-200a.csv',
     'LyricVideo_480P-2c50.csv',
     'LyricVideo_480P-6385.csv',
     'LyricVideo_720P-1c89.csv',
     'LyricVideo_720P-2d24.csv',
     'MusicVideo_360P-648c.csv',
     'MusicVideo_480P-6fb6.csv',
     'NewsClip_360P-0c17.csv',
     'NewsClip_480P-7a0d.csv',
     'Sports_720P-6365.csv',
     'Vlog_360P-3121.csv',
     'Vlog_720P-329f.csv']
...
```
    ...
    Config min std :  191
    Config max std :  103
    Config med std :  55.244704140977106



    
![png](cpu_files/cpu_36_1.png)
    



    
![png](cpu_files/cpu_36_2.png)
...
```
    ...
    For config. 200,  37 % of configurations are between 105 and 130!
...
```
    ...
    (array([  10,   31,   68,   69,  182,  212,  222,  233,  329,  430,  459,
             475,  476,  490,  528,  644,  646,  654,  686,  694,  696,  701,
             703,  709,  730,  743,  754,  770,  877,  899,  900,  906,  911,
             922,  925,  929,  936,  942,  978, 1072, 1082, 1137, 1173, 1184,
            1197, 1200, 1217, 1304, 1370, 1377, 1382, 1385]),)
...
```
    ...
    WilcoxonResult(statistic=15033.5, pvalue=0.13547327356133576)
...
```
    ...
    WilcoxonResult(statistic=12555.5, pvalue=6.7646620057039834e-21)
...
```
    ...
    WilcoxonResult(statistic=13953.0, pvalue=0.31553390346883037)
...
```
    ...
    WilcoxonResult(statistic=19633.0, pvalue=3.6477922394875774e-08)
...
```
    ...
    WilcoxonResult(statistic=22126.5, pvalue=1.0)
...
```
    ...
    WilcoxonResult(statistic=6888.5, pvalue=5.372562215319436e-35)
...
```
    ...
    WilcoxonResult(statistic=21908.5, pvalue=0.0007961806195742114)
